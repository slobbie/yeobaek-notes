  ...
  return <>
    ...
    <main className="site-shell">
      ...
      <section className={styles.controls} aria-label="글 필터">
        ...
        <label className={styles.search}><span className="sr-only">글 검색</span><MagnifyingGlass aria-hidden="true" size={18} weight="bold" /><input type="search" autoComplete="off" value={query} onChange={(event) => setQuery(event.target.value)} onBlur={trackSearch} placeholder="제목이나 태그를 검색해보세요" /></label>
      </section>
